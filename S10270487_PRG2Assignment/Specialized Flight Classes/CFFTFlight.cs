...
{
    class CFFTFlight : Flight   // inheritance
    {
        // properties
        ...
        public CFFTFlight(string fNo, string origin, string dest, DateTime expTime, string status, double reqFee) :
        ...
        public override string ToString()
        {
            return base.ToString() +
                "\tSpecial Request: Connecting Flight Fast Transfer Requested" +
                "\tFee: " + CalculateFees();
        }
    }
}
